        ...
        <div className="upload-shell" id="upload">
          ...
          <div className="upload-card">
            <div className="upload-head">
              ...
              <p>Supported format: PNG, JPG, PDF upto 10MB</p>
            </div>
          ...
          <div className="projects-grid">
            <div className="project-card group">
              <div className="preview">
                <img src="https://roomify-mlhuk267-dfwu1i.puter.site/projects/1770803585402/rendered.png" alt="images" />
                <div className="badge">
                  <span>Community</span>
                </div>
              </div>
              ...
              <div className="card-body">
                <div>
                  ...
                  <div className="meta">
                    <Clock size={12}/>
                    <span>{new Date('10.04.2026').toLocaleDateString()}</span>
